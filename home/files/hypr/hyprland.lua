...
-- External Samsung 4K above laptop, centered
hl.monitor({
    output   = "DP-1",
    mode     = "3840x2160@60",
    position = "0x0",
...
-- Laptop screen below external, horizontally centered
-- eDP-1 logical width = 1920/1.5 = 1280; DP-1 logical width = 3840/1.5 = 2560
-- x offset to center: (2560 - 1280) / 2 = 640; y = DP-1 logical height = 2160/1.5 = 1440
hl.monitor({
    output   = "eDP-1",
...
-- Workspaces 1-5 on external (DP-1 or DP-3), 6-10 on laptop (eDP-1)
...
hl.on("hyprland.start", function ()
  ...
  hl.exec_cmd("waynergy sixseven-windows")
end)
...
hl.config({
    ...
    decoration = {
        ...
        -- Transparency is managed per-monitor by opacity-manager.py
        active_opacity   = 1.0,
...
-- move windows with SHIFT+SUPER and arrows
...
-- Next/prev workspace (also used by mouse side buttons via logiops)
